...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  changeTheme(theme:string)
  {
    ...
    // if (theme === 'dark')
    //   body.style.backgroundImage = "url('../../../assets/bg/b5.jpg')"
    // else
    //   body.style.backgroundImage = "url('../../../assets/bg/b1.jpg')"
  }
  ...
  getLanguageFlag(): string {
    //console.log('getLanguageFlag Language:', this.user_profile?.preferred_language);
    return `assets/flags/${this.user_profile?.preferred_language}.png`;
  }
